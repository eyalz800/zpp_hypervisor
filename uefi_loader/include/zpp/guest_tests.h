...
private:
    ...
    static constexpr std::uint32_t exit_hlt = 12;
    static constexpr std::uint32_t exit_invd = 13;
    static constexpr std::uint32_t exit_invlpg = 14;
    static constexpr std::uint32_t exit_rdpmc = 15;
    static constexpr std::uint32_t exit_rdtsc = 16;
    ...
    static constexpr std::uint32_t exit_mov_debug_register = 29;
    ...
    static constexpr std::uint32_t exit_pause = 40;
    static constexpr std::uint32_t exit_rdtscp = 51;
    static constexpr std::uint32_t exit_wbinvd = 54;
    static constexpr std::uint32_t exit_rdrand = 57;
    static constexpr std::uint32_t exit_invpcid = 58;
    static constexpr std::uint32_t exit_rdseed = 61;
