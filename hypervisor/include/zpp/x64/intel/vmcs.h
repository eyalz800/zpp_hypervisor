...
public:
     ...
     */
    std::expected<void, zpp::error> write(field field,
    ...
    std::expected<void, zpp::error> vpid(std::uint64_t value) const
    {
        return write(field::vpid, value);
    }

    std::expected<std::uint64_t, zpp::error>
    posted_interrupt_notification_vector() const
    {
    ...
    std::expected<void, zpp::error> eptp_index(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_es_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_cs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ss_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ds_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_fs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ldtr_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_tr_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_interrupt_status(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> pml_index(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_es_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_cs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ss_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ds_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_fs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_gs_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_tr_selector(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> io_bitmap_a(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> io_bitmap_b(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> msr_bitmap(std::uint64_t value) const
    {
        return write(field::msr_bitmap, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_msr_store_address() const
    {
        return read(field::vm_exit_msr_store_address);
    }

    std::expected<void, zpp::error>
    vm_exit_msr_store_address(std::uint64_t value) const
    {
        return write(field::vm_exit_msr_store_address, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_msr_load_address() const
    {
        return read(field::vm_exit_msr_load_address);
    }

    std::expected<void, zpp::error>
    vm_exit_msr_load_address(std::uint64_t value) const
    {
        return write(field::vm_exit_msr_load_address, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_entry_msr_load_address() const
    {
        return read(field::vm_entry_msr_load_address);
    }

    std::expected<void, zpp::error>
    vm_entry_msr_load_address(std::uint64_t value) const
    {
        return write(field::vm_entry_msr_load_address, value);
    }

    std::expected<std::uint64_t, zpp::error>
    excecutive_vmcs_pointer() const
    {
        return read(field::excecutive_vmcs_pointer);
    }

    std::expected<void, zpp::error>
    excecutive_vmcs_pointer(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> pml_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> tsc_offset(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    virtual_apic_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    apic_access_address(std::uint64_t value) const
    {
        return write(field::apic_access_address, value);
    }

    std::expected<std::uint64_t, zpp::error>
    posted_interrupt_descriptor_address() const
    {
    ...
    std::expected<void, zpp::error>
    vm_function_controls(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> ept_pointer(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    eio_exit_bitmap_0(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    eio_exit_bitmap_1(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    eio_exit_bitmap_2(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    eio_exit_bitmap_3(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    eptp_list_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vmread_bitmap_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vmwrite_bitmap_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    xss_exiting_bitmap(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    encls_exiting_bitmap(std::uint64_t value) const
    {
        return write(field::encls_exiting_bitmap, value);
    }

    std::expected<std::uint64_t, zpp::error>
    sub_page_permission_table_pointer() const
    {
        return read(field::sub_page_permission_table_pointer);
    }

    std::expected<void, zpp::error>
    sub_page_permission_table_pointer(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    tsc_multiplier(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_physical_address(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vmcs_link_pointer(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ia32_debugctl(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ia32_pat(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ia32_efer(std::uint64_t value) const
    {
        return write(field::guest_ia32_efer, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_ia32_perf_global_ctrl() const
    {
        return read(field::guest_ia32_perf_global_ctrl);
    }

    std::expected<void, zpp::error>
    guest_ia32_perf_global_ctrl(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_pdpte_0(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_pdpte_1(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_pdpte_2(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_pdpte_3(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ia32_bndcfgs(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ia32_pat(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ia32_efer(std::uint64_t value) const
    {
        return write(field::host_ia32_efer, value);
    }

    std::expected<std::uint64_t, zpp::error>
    host_ia32_perf_global_ctrl() const
    {
        return read(field::host_ia32_perf_global_ctrl);
    }

    std::expected<void, zpp::error>
    host_ia32_perf_global_ctrl(std::uint64_t value) const
    {
        return write(field::host_ia32_perf_global_ctrl, value);
    }

    std::expected<std::uint64_t, zpp::error>
    pin_based_vm_execution_controls() const
    {
        return read(field::pin_based_vm_execution_controls);
    }

    std::expected<void, zpp::error>
    pin_based_vm_execution_controls(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    exception_bitmap(std::uint64_t value) const
    {
        return write(field::exception_bitmap, value);
    }

    std::expected<std::uint64_t, zpp::error>
    page_fault_error_code_mask() const
    {
        return read(field::page_fault_error_code_mask);
    }

    std::expected<void, zpp::error>
    page_fault_error_code_mask(std::uint64_t value) const
    {
        return write(field::page_fault_error_code_mask, value);
    }

    std::expected<std::uint64_t, zpp::error>
    page_fault_error_code_match() const
    {
        return read(field::page_fault_error_code_match);
    }

    std::expected<void, zpp::error>
    page_fault_error_code_match(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr3_target_count(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vm_exit_controls(std::uint64_t value) const
    {
        return write(field::vm_exit_controls, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_msr_store_count() const
    {
        return read(field::vm_exit_msr_store_count);
    }

    std::expected<void, zpp::error>
    vm_exit_msr_store_count(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vm_exit_msr_load_count(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vm_entry_controls(std::uint64_t value) const
    {
        return write(field::vm_entry_controls, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_entry_msr_load_count() const
    {
        return read(field::vm_entry_msr_load_count);
    }

    std::expected<void, zpp::error>
    vm_entry_msr_load_count(std::uint64_t value) const
    {
    ...
    std::expected<std::uint64_t, zpp::error>
    vm_entry_exception_error_code() const
    {
        return read(field::vm_entry_exception_error_code);
    }

    std::expected<void, zpp::error>
    vm_entry_exception_error_code(std::uint64_t value) const
    {
        return write(field::vm_entry_exception_error_code, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_entry_instruction_length() const
    {
        return read(field::vm_entry_instruction_length);
    }

    std::expected<void, zpp::error>
    vm_entry_instruction_length(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    trr_threshold(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> ple_gap(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> ple_window(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    vm_instruction_error(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> exit_reason(std::uint64_t value) const
    {
        return write(field::exit_reason, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_interruption_information() const
    {
        return read(field::vm_exit_interruption_information);
    }

    std::expected<void, zpp::error>
    vm_exit_interruption_information(std::uint64_t value) const
    {
        return write(field::vm_exit_interruption_information, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_interruption_error_code() const
    {
        return read(field::vm_exit_interruption_error_code);
    }

    std::expected<void, zpp::error>
    vm_exit_interruption_error_code(std::uint64_t value) const
    {
        return write(field::vm_exit_interruption_error_code, value);
    }

    std::expected<std::uint64_t, zpp::error>
    idt_vectoring_information_field() const
    {
        return read(field::idt_vectoring_information_field);
    }

    std::expected<void, zpp::error>
    idt_vectoring_information_field(std::uint64_t value) const
    {
        return write(field::idt_vectoring_information_field, value);
    }

    std::expected<std::uint64_t, zpp::error>
    idt_vectoring_error_code() const
    {
        return read(field::idt_vectoring_error_code);
    }

    std::expected<void, zpp::error>
    idt_vectoring_error_code(std::uint64_t value) const
    {
        return write(field::idt_vectoring_error_code, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_instruction_length() const
    {
        return read(field::vm_exit_instruction_length);
    }

    std::expected<void, zpp::error>
    vm_exit_instruction_length(std::uint64_t value) const
    {
        return write(field::vm_exit_instruction_length, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vm_exit_instruction_information() const
    {
        return read(field::vm_exit_instruction_information);
    }

    std::expected<void, zpp::error>
    vm_exit_instruction_information(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_es_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_cs_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ss_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ds_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_fs_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gs_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ldtr_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_tr_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gdtr_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_idtr_limit(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_es_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_cs_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ss_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ds_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_fs_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gs_access_rights(std::uint64_t value) const
    {
        return write(field::guest_gs_access_rights, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_ldtr_access_rights() const
    {
        return read(field::guest_ldtr_access_rights);
    }

    std::expected<void, zpp::error>
    guest_ldtr_access_rights(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_tr_access_rights(std::uint64_t value) const
    {
        return write(field::guest_tr_access_rights, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_interruptibility_state() const
    {
        return read(field::guest_interruptibility_state);
    }

    std::expected<void, zpp::error>
    guest_interruptibility_state(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_activity_state(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_smbase(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ia32_sysenter_cs(std::uint64_t value) const
    {
        return write(field::guest_ia32_sysenter_cs, value);
    }

    std::expected<std::uint64_t, zpp::error>
    vmx_preemption_timer_value() const
    {
        return read(field::vmx_preemption_timer_value);
    }

    std::expected<void, zpp::error>
    vmx_preemption_timer_value(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ia32_sysenter_cs(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr0_guest_host_mask(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr4_guest_host_mask(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr0_read_shadow(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr4_read_shadow(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr3_target_value_0(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr3_target_value_1(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr3_target_value_2(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    cr3_target_value_3(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_cr0(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_cr3(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_cr4(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_es_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_cs_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ss_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ds_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_fs_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gs_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_ldtr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_tr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_gdtr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    guest_idtr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_dr7(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_rsp(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_rip(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> guest_rflags(std::uint64_t value) const
    {
        return write(field::guest_rflags, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_pending_debug_exceptions() const
    {
        return read(field::guest_pending_debug_exceptions);
    }

    std::expected<void, zpp::error>
    guest_pending_debug_exceptions(std::uint64_t value) const
    {
        return write(field::guest_pending_debug_exceptions, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_ia32_sysenter_esp() const
    {
        return read(field::guest_ia32_sysenter_esp);
    }

    std::expected<void, zpp::error>
    guest_ia32_sysenter_esp(std::uint64_t value) const
    {
        return write(field::guest_ia32_sysenter_esp, value);
    }

    std::expected<std::uint64_t, zpp::error>
    guest_ia32_sysenter_eip() const
    {
        return read(field::guest_ia32_sysenter_eip);
    }

    std::expected<void, zpp::error>
    guest_ia32_sysenter_eip(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_cr0(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_cr3(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_cr4(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_fs_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_gs_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_tr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_gdtr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_idtr_base(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ia32_sysenter_esp(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error>
    host_ia32_sysenter_eip(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_rsp(std::uint64_t value) const
    {
    ...
    std::expected<void, zpp::error> host_rip(std::uint64_t value) const
    {
