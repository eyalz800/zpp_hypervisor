 ...
 * handler.
 */
extern "C" void __attribute__((naked)) zpp_x64_exception_common()
{
    asm(R"!!(
        ...
        mov rdi, rsp
        sub rsp, 0x8
        call zpp_x64_exception
        // zpp_x64_exception never returns.
        ud2
    )!!");
}
...
zpp_x64_exception_entry_table()
{
    asm(R"!!(
        ...
        .set zpp_x64_error_code_mask, 0
        .irp vector, 8, 10, 11, 12, 13, 14, 17, 21, 29, 30
        .set zpp_x64_error_code_mask, zpp_x64_error_code_mask | (1 << \vector)
        .endr

        .set zpp_x64_vector, 0
        .rept 256
        .balign 16
        ...
        .if (zpp_x64_vector > 30) || !((zpp_x64_error_code_mask >> zpp_x64_vector) & 1)
        push 0
        .endif
        ...
        jmp zpp_x64_exception_common

        .set zpp_x64_vector, zpp_x64_vector + 1
        .endr
    )!!");
}
